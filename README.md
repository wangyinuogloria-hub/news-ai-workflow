...
这个工作流是为传统媒体记者开发的。在各地市级广电、报纸和新媒体编辑部，记者们面临着同样的困境——"永远在路上"。采访花掉大半天，回来还要搜资料、扒同期声、排结构、写初稿、改稿子。真正用来做内容的时间，被大量重复劳动挤压。

这个工作流通过观察记者的真实写稿模式，全仿真模拟了记者从选题到成稿的完整流程。记者可以在采访回来的路上、在地铁上、在车里，把选题和采访素材输入进去，AI 自动完成背景调查、同期声筛选、角度策划和初稿写作。回到台里，稿子已经成型，直接进入剪辑环节。
