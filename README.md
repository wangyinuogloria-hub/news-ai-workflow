...
<p align="center">
  ...
  一个用 Claude Code 自然语言开发的电视新闻 AI 辅助写作系统
</p>
...
这是一个面向电视新闻记者的 AI 写稿工作流。你输入选题和采访素材，AI 按照严格的新闻写作规范，自动完成：
...
- ✍️ **自动写稿** — 按电视新闻格式输出完整稿件，支持对话修改

> 大二传媒生做的。不会写代码，全靠自然语言 + AI 迭代 100+ 轮打磨出来的。
